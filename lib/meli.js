...
var Meli = function (client_id, client_secret, access_token, refresh_token) {
   ...
   /**
     ...
     *
     */
    this.getAuthURL = function (redirect_uri, callback) {
        ...
        console.log(query);
      //  console.log(config.auth_url + convertObjectToQueryString(query));
             callback(config.auth_url + convertObjectToQueryString(query));    
           };
